...
##    base_model = InceptionV3(weights=None , include_top=False, input_tensor=None, input_shape=(299, 299, 3), pooling='avg') 
    ...
    model.summary()
    model.load_weights('./Experiments/PH_1/EX_57/EX_57.hdf5')
...
test_df = pd.read_csv('./labels/EyePACS_2015_new_val.csv')

predicted = []

for i, name in tqdm(enumerate(test_df['image'])):

    path = os.path.join('/data1/visionlab/data/EyePACS_2015/original/diabetic-retinopathy-detection/EyePACS_512_all', name + '.jpeg')
